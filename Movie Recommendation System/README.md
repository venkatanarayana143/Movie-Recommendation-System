...
The details of the movies(title, genre, runtime, rating, poster, etc) are fetched using an API by TMDB, https://www.themoviedb.org/documentation/api, and using the IMDB id of the movie in the API, I did web scraping to get the reviews given by the user in the IMDB site using `beautifulsoup4` and performed sentiment analysis on those reviews Note

## 

Source Code: https://github.com/venkatanarayana143/Movie-Recommendation-System-with-Sentiment-Analysis
...
1. Install all the libraries mentioned in the [requirements.txt](https://github.com/venkatanarayana143/Movie-Recommendation-System-with-Sentiment-Analysis/blob/master/requirements.txt) file.
